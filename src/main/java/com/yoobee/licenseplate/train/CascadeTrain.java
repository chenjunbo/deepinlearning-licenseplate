...
import com.yoobee.licenseplate.util.ImageUtil;
...
public class CascadeTrain {
    ...
    public static void preparePosSamples(String sourcePath, String targetPath, Integer limit) {
        ...
        //TODO DEFAULT_FACE_MODEL_PATH
        CascadeClassifier faceDetector = new CascadeClassifier(Constant.DEFAULT_PLATE_MODEL_PATH);
        int i = 0;
