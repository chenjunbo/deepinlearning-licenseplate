...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{ \gamma Parameter (Gamma)}: Used primarily with non-linear kernels like RBF. A larger  \gamma value makes the model fit the training data more closely, potentially leading to overfitting, while a smaller γ leads to a smoother decision boundary, potentially underfitting.
	\end{itemize}
